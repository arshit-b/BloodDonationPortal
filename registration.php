...
<?php
    ...
    $docid = stripslashes($_REQUEST['docid']);
        ...
        $query = "INSERT into `doc_register` (username, password, name, email, docid, hostype, hospital, county) VALUES ('$username', '".md5($password)."', '$name', '$email', '$docid','$hostype', '$hospital', '$county')";
