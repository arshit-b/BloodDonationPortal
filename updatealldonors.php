...
if (isset($_POST['push'])) {
  ...
  $dtype=$_POST['dtype'];
	...
	$query="UPDATE bloodonor, submit_details SET fname='$fname', lname='$lname', email='$email',gender='$gender',bday='$bday',age='$age',weight='$weight',county='$county',postal='$postal',address='$address',dtype='$dtype' WHERE id='$id'";
	...
	if($result)
	{
                ...
                echo "<script type='text/javascript'>alert('Your update was successful!!'); document.location.href = 'alldonorprofile.php';</script>";
	}
