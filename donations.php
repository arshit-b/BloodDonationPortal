    ...
    <ul class="nav navbar-nav">
      ...
      <li class="dropdown">
        ...
        <ul class="dropdown-menu">
          <li><a href="doclogin.php"> Portal</a></li>
...
$sql = "SELECT submit_details.b_id,submit_details.sub_id,submit_details.dtype,submit_details.organ FROM submit_details WHERE b_id='$getid '";
